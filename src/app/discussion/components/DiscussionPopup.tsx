  ...
  return (
    <div>
      <div
        ...
        tabIndex={-1}
        aria-hidden='false'
        className='show overflow-y-auto overflow-x-hidden pt-10 fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black bg-opacity-90'
      >
